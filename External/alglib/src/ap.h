...
void _ialglib_vcopy_complex(ae_int_t n, const ae_complex *a, ae_int_t stridea, double *b, ae_int_t strideb, char *conj);
void _ialglib_vcopy_complex(ae_int_t n, const double *a, ae_int_t stridea, double *b, ae_int_t strideb, char *conj);
